...
public extension String {
    ...
    public func fs_getStringBetweenString (_ firstString: String, secondString: String) -> String? {
        ...
        let stringBefore = String(self[..<lFirstRange.upperBound])
        string = self.replacingOccurrences(of: stringBefore, with: "")
        
        guard let lSecondRange = string.range(of: secondString) else {return nil}
        let stringAfter = String(self[lSecondRange.lowerBound...])
    ...
    public subscript (range: Range<Int>) -> String {
        return String(self[Range(self.index(self.startIndex, offsetBy: range.lowerBound) ..< self.index(self.startIndex, offsetBy: range.upperBound))])
    }
}
